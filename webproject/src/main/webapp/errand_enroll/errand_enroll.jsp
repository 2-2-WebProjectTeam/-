...
<body>
    ...
    <form method="post" action="enrollAction.jsp">
        <fieldset class="form">
            <table style="width: 100%;">
                ...
                <tr>
                    <td><input type="text" name="errandTopic" class="input-field"></td><br>
                </tr>
                <tr>
                    <td>기한</td>
                </tr>
                <tr>
                    <td><input type="text" name="errandDeadLine" class="input-field"></td>
                </tr>
                <tr>
                    <td>장소</td>
                </tr>
    ...
    <script>
    	...
    	function sendData(errandType) {
        	document.getElementById("hiddenField").value = errandType;
    	}
